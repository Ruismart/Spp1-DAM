...
top.genes$NvsC <- c(rets$NvsC$up[1:40],rets$NvsC$down[6:1])
#top.genes$NvsC <- c(rets$NvsC$up[1:23],rets$NvsC$down[9:1])

top.genes$PvsC <- c(rets$PvsC$up[1:40],rets$PvsC$down[40:1])

top.genes$PvsN <- c(rets$PvsN$up[1:40],rets$PvsN$down[40:1])
#top.genes$PvsN <- c(rets$PvsN$up[1:21],rets$PvsN$down[28:1])
```
